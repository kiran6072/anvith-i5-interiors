...
export function Projects({
  ...
  const projects: Project[] = Array.from({ length: 66 }, (_, i) => ({
    id: String(i + 1),
    title: "ANVITH i5 Interior Project",
    category: "Interior Design",
    location: "Bangalore",
    image_url: `/${i + 1}.jpeg`,
    description: "Premium Interior Design Project",
  }));
  ...
  <div className="container-luxe">
      ...
      {visible.map((p, i) => (
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 p-6">
            <div className="text-[0.62rem] uppercase tracking-[0.28em] text-gold">
              {p.category}
            </div>
    ...
    {visible.length === 0 && (
      <p className="mt-12 text-center text-sm text-muted-foreground">
        Portfolio is being updated. Please check back later for more projects.
      </p>
    )}
  </div>
</section>
