...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Bespoke modular kitchens, turnkey home interiors and custom furniture by Bharath Gowda M. 16+ years, 150+ projects across Bangalore." },
      { name: "author", content: "ANVITH i5 Interior & Furnitures" },
      { name: "theme-color", content: "#101010" },
      { property: "og:title", content: "ANVITH i5 — Luxury Interior Designers, Bangalore" },
      { property: "og:description", content: "Bespoke interiors and custom furniture. 16+ years in Whitefield, Bangalore." },
